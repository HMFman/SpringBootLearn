...
/**
 * Created by HMF on 2021/06/30 16:45
 */
@Controller
public class NotifyController {
    // 接收支付宝返回的异步通知的信息
    @RequestMapping("/getNotify")
    public void getNotify(HttpServletRequest request, HttpServletResponse response) throws IOException, AlipayApiException {
        //获取支付宝POST过来反馈信息
        ...
        //——请在这里编写您的程序（以下代码仅作参考）——
        /**
         * 实际验证过程建议商户务必添加以下校验：异步通知: 其实是双保险机制, 如果同步通知后没有跳转到你的网址, 可能用户关了, 可能网速慢, 即无法
